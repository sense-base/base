# Contributing to `sense-base/base`.
...
## New issues
* Open an issue (bug report, feature request, or something is not working): https://github.com/sense-base/base/issues/new/choose
...
9.1 You can navigate branches in https://github.com/sense-base/base/branches and removed merged branches by clickling :wastebasket: icon.    
